...
```
┌──────────────────────────────────────────────────────────────┐
│  NTFS Recovery Tool v2.0                                     │
│  Récupération sécurisée des droits NTFS avec sauvegarde      │
├──────────────────────────────────────────────────────────────┤
│  📀 Disque source: [D: - Disque externe    ▼] [Refresh]     │
│  🪪 Compte cible:  [Administrateurs                    ]     │
│  ⚙️ Mode: ○ Normal  ● Dry-Run (simulation)                  │
│  📦 ☑ Activer la sauvegarde avant modification              │
├──────────────────────────────────────────────────────────────┤
│  👥 Utilisateurs détectés                                    │
│  ☐ Jean.Dupont    D:\Users\Jean.Dupont    12.5 GB           │
│  ☐ Marie.Martin   D:\Users\Marie.Martin    8.2 GB           │
├──────────────────────────────────────────────────────────────┤
│  📋 Journal d'exécution                                      │
│  [2026-01-29 10:45:00] [INFO] Analyse du disque D:...       │
│  [2026-01-29 10:45:02] [INFO] Trouvé 2 utilisateurs         │
├──────────────────────────────────────────────────────────────┤
│  [▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░] [Exécuter] [Ouvrir log] [Fermer]   │
└──────────────────────────────────────────────────────────────┘
```
...
```powershell
# Cloner le dépôt
git clone https://github.com/VOTRE_USERNAME/ntfs-recovery-tool.git
cd ntfs-recovery-tool
```
